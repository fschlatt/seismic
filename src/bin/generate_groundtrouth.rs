...
pub fn main() {
    ...
    let dataset = SparseDataset::<u16, f32>::read_bin_file(&args.input_file.unwrap()).unwrap();
    let queries = SparseDataset::<u16, f32>::read_bin_file(&args.query_file.unwrap()).unwrap();
    let k = args.k;
